...
url = 'https://forum.netmarble.com/api/game/stonemmogb/official/forum/stone_cn/article/list?rows=15&start=0&menuSeq=2&_=1700000000000'

if __name__ == '__main__':
    newurl, aid, menuseq = serchurl(url, 'cn')
    if newurl:
